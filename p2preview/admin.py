...
class PersonAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'email', 'password',
                    'lastLogined', 'lastLogouted', 'personType', 'token', 'tasktimeinmin', 'time_lapsed', 'logincount']
...
class ActivityAdmin(admin.ModelAdmin):
    list_display = ['id', 'courseId', 'rubricId', 'name',
                    'code', 'duration', 'isActive', 'groupSize', 'textOrImage']
...
admin.site.register(RegisteredGroupsForActivity,
                    RegisteredGroupsForActivityAdmin)
